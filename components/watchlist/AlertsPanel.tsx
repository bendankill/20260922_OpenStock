                                ...
                                <div>
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-gray-400">目标价：{formatCurrency(alert.targetPrice)}</div>
                                        </div>
                                    </div>
                                    <div className="mt-2 text-xs text-yellow-500 font-medium">
                                        条件：价格{alert.condition.toLowerCase() === 'above' ? '高于' : '低于'} {formatCurrency(alert.targetPrice)}
                                    </div>
