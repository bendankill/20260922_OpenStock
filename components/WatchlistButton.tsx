...
const WatchlistButton = ({
    ...
    if (type === "icon") {
        return (
            <button
                type="button"
                title={added ? `将 ${symbol} 从自选股移除` : `将 ${symbol} 加入自选股`}
                aria-label={added ? `将 ${symbol} 从自选股移除` : `将 ${symbol} 加入自选股`}
